...
export const pelleRifts = {
  vacuum: {
    ...
    milestones: [
      ...
      },
      {
        ...
        effect: () => Decimal.pow(4, PelleRifts.vacuum.totalFill.log10().toNumber() / 2 / 308 + 3),
  ...
  decay: {
    ...
    // 0 - 1
    percentage: totalFill => totalFill.plus(1).log10().toNumber() * 0.05 / 100,
    // 0 - 1
    ...
    effect: totalFill => (PelleRifts.chaos.milestones[0].canBeApplied
      ? Decimal.sqrt(2000 + 1) : Decimal.sqrt(totalFill.plus(1).log10().toNumber() + 1)),
  ...
  recursion: {
    ...
    percentage: totalFill => totalFill.plus(1).log10().toNumber() ** 0.4 / 4000 ** 0.4,
    percentageToFill: percentage => Decimal.pow(10, percentage ** 2.5 * 4000).minus(1),
    effect: totalFill => new Decimal(58 * totalFill.plus(1).log10().toNumber() ** 0.2 / 4000 ** 0.2),
  ...
  paradox: {
    ...
    percentage: totalFill => totalFill.plus(1).log10().toNumber() / 100,
    percentageToFill: percentage => Decimal.pow10(percentage * 100).minus(1),
    effect: totalFill => new Decimal(1 + totalFill.plus(1).log10().toNumber() * 0.004),
