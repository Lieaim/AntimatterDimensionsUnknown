...
export const singularityMilestones = {
  ...
  multFromInfinitied: {
    ...
    effect: () => Math.clampMin(Currency.infinitiesTotal.value.pLog10().toNumber() / 1000, 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  ...
  darkFromTheorems: {
    ...
    effect: () => Math.sqrt(Math.clampMin((Currency.timeTheorems.value.log10().toNumber() - 1000) / 50, 1)),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  dim4Generation: {
  ...
  darkFromDilatedTime: {
    ...
    effect: () => Math.pow(1.6, Decimal.log10(Currency.dilatedTime.value.plus(1)).toNumber() / 1000),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  infinitiedPow: {
